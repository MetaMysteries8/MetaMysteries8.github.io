...
(() => {
  ...
  function renderLines(){
    ...
    state.lines.forEach((l,i)=>{
      ...
      el.querySelectorAll('[data-act]').forEach(b=>b.onclick=()=>{const a=b.dataset.act;if(a==='up')moveLine(l.id,-1);if(a==='down')moveLine(l.id,1);if(a==='play-from')playFrom(l.id);if(a==='duplicate')duplicateLine(l.id);if(a==='add-after')addLine(l.id);if(a==='delete')deleteLine(l.id)});
  ...
  state.autosaveReady=true;renderLines();
})();
